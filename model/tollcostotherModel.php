...
Class tollcostotherModel Extends baseModel {
	protected $table = "toll_cost_other";
    ...
    public function deleteToll($id){
    	if ($this->getToll($id)) {
    		return $this->delete($this->table,array('toll_cost_other_id'=>$id));
    	}
    }
    ...
    public function getAllTollByWhere($id){
        return $this->query('SELECT * FROM toll_cost_other WHERE toll_cost_other_id != '.$id);
    }
    public function getLastToll(){
        return $this->getLast($this->table);
    }
    public function checkToll($id,$toll_name){
        return $this->query('SELECT * FROM toll_cost_other WHERE toll_cost_other_id != '.$id.' AND toll_name = '.$toll_name);
    }
