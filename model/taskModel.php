...
Class taskModel Extends baseModel {
    ...
    public function checkTask($id,$work_date,$work,$assigned){
        return $this->query('SELECT * FROM task WHERE task_id != '.$id.' AND work_date = '.$work_date.' AND work = '.$work.' AND assigned = '.$assigned);
    }
}
?>