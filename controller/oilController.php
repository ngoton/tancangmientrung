...
Class oilController Extends baseController {
    ...
    public function index() {
        ...
        if ($_SESSION['role_logined'] != 1 && $_SESSION['role_logined'] != 7 && $_SESSION['role_logined'] != 8 && $_SESSION['role_logined'] != 4 && $_SESSION['role_logined'] != 3 && $_SESSION['role_logined'] != 9) {
