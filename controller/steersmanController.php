    ...
    public function add(){
        ...
        if (isset($_POST['yes'])) {
            ...
            if ($_POST['yes'] != "") {
                ...
                //var_dump($data);
                if ($steersman->checkSteersman($_POST['yes'],trim($_POST['steersman_name']),trim($_POST['steersman_code']))) {
                ...
                //var_dump($data);
                if ($steersman->getSteersmanByWhere(array('steersman_name'=>$data['steersman_name'],'steersman_code'=>$data['steersman_code']))) {
                    echo "Thông tin này đã tồn tại";
                    return false;
                }
                else{
